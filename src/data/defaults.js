...
export const defaultProject = () => ({
  ...
  assets: [],
  // Financing (Phase 2)
  finMode: "fund", // self | debt | bank100 | fund | incomeFund | hybrid
  ...
  operatorFeeCap: 600000, // Max annual operator fee (0 = no cap)
  ...
  _waterfallVersion: 2, // Migration flag: simplified waterfall (no pref/carry, performance incentive only)
});
