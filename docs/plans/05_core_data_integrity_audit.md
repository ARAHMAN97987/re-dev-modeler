...
## تحديث المنهجية (مضاف بعد تدقيق جزء 2)

### الدرس المستفاد

الفحص الآلي (audit_part2_capital.cjs) أعطى 61/61 PASSED — لكن التدقيق السطري اليدوي كشف 4 مشاكل لم يلتقطها الاختبار الآلي:

1. **Dashboard double-counting** — landPurchasePrice محسوب مرتين
2. **waterfall.js devFeeTotal** — محسوب من الصفر بدل القراءة من financing
3. **ExcelExport fees** — مشتقة بالطرح (balancing item) بدل القراءة المباشرة
4. **Dashboard capitalizeIDC** — Sources ≠ Uses عند تفعيل IDC

**السبب:** الاختبار الآلي يتحقق إن المحرك يحسب صح — لكنه لا يتحقق إن **الواجهة تقرأ الرقم الصح من المكان الصح**.

### الخطوة المضافة: تدقيق سطري متكرر

بعد كل اختبار آلي، يُضاف:

**الخطوة 2.5 — التدقيق السطري:**
- لكل حقل خارج من المحرك: أبحث عن **كل** مكان يقرأه بالتطبيق
- أقرأ **سطر بسطر** كيف يُستخدم
- أتحقق: هل يقرأ من `f.field` مباشرة أو يحسب يدوي؟
- أتحقق: هل فيه double-counting أو balancing items؟
- أتحقق: هل Sources = Uses بكل السيناريوهات (بما فيها capitalizeIDC)؟
- **يُكرر** بعد كل إصلاح لأن الإصلاح قد يكشف مشاكل جديدة

### القاعدة الجديدة

> **الاختبار الآلي يثبت إن المحرك صحيح.**
> **التدقيق السطري يثبت إن الواجهة تقرأ صح.**
> **كلاهم مطلوب. الاختبار الآلي وحده غير كافي.**
